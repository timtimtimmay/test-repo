          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-semibold text-gray-900 leading-tight">Workforce Task Intelligence</span>
                <span className="text-xs text-gray-500 hidden sm:block">Task-level intelligence for AI transformation</span>
              </div>
            </Link>
          </div>
          ...
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="flex flex-col space-y-3">
              ...
              <div className="border-t border-gray-200 pt-3 mt-2">
                ...
                <Link
                  href="/portfolio"
                  className="text-sm font-medium text-slate-700 hover:text-slate-900 px-2 py-1 mt-2"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Portfolio
                </Link>
